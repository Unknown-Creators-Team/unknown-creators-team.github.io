    ...
    function login() {
        ...
        if (host === "127.0.0.1") {
            window.location.href =
                "https://discord.com/oauth2/authorize?client_id=1134773310127878274&response_type=code&redirect_uri=http%3A%2F%2F127.0.0.1%3A5500%2Flogin.html&scope=guilds+identify+email";
        } else if (host == "192.168.1.45") {
            window.location.href =
                "https://discord.com/oauth2/authorize?client_id=1134773310127878274&response_type=code&redirect_uri=http%3A%2F%2F192.168.1.45%3A5500%2Flogin.html&scope=guilds+identify+email";
